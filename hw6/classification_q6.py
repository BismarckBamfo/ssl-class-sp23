...
if __name__ == "__main__":
    ...
    print(" >>>>>>>>  QUESTION 6 ... ")
    ac, ep, val = train(pretrained_model, args.num_epochs, train_dataloader, validation_dataloader, args.device, args.lr)
    ...
    plt.title('Training/Dev Accuracy')
    plt.xlabel('Epochs')
    plt.ylabel('Accuracy')
    plt.legend()
    ...
    #save the graph
    plt.savefig('/home/bodoom1/repos/csci-601-771-self-supervised-models/sp2023/hw6/train_dev_acc_q6.png')
